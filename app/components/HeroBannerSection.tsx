  ...
  return (
    <section className="relative w-full bg-[#fffdf7]">
      <header className="flex items-center justify-center px-4 sm:px-6 lg:px-4 pt-6 sm:pt-10 lg:pt-14 pb-0">
        <nav className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-8 lg:gap-24 px-4 sm:px-[15.62px] py-3 sm:py-[13.02px] bg-[#fffaef] rounded-[104.16px] w-full max-w-6xl">
      ...
      <div className="flex items-center justify-center px-4 sm:px-6 lg:px-4 py-10 sm:py-14 lg:py-20">
        <div className="flex flex-col lg:flex-row w-full max-w-[1298px] items-center justify-between gap-6 sm:gap-8 lg:gap-8">
          <div className="flex flex-col w-full lg:max-w-[633px] items-start gap-8 sm:gap-10 lg:gap-12">
            ...
            <div className="inline-flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
              ...
              <Button className="h-auto w-full sm:w-auto inline-flex items-center justify-center gap-[13.02px] px-4 sm:px-6 lg:px-[31.25px] py-3 sm:py-4 lg:py-[20.83px] bg-[#164672] hover:bg-[#164672]/90 rounded-[59.89px] overflow-hidden">
