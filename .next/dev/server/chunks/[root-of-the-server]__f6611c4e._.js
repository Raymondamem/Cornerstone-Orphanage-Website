...
"[project]/app/api/settings/homepage/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const col = db.collection('settings_homepage');
...
async function PUT(req) {
    try {
        ...
        const { titleText, titleContent, imageUrl } = body;
        const db = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDatabase"])();
        const col = db.collection('settings_homepage');
        const update = {
            updatedAt: new Date()
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6611c4e._.js.map