...
async function GET(request) {
    try {
        ...
        const includeDrafts = [
            '1',
            'true'
        ].includes((searchParams.get('includeDrafts') || '').toLowerCase());
        ...
        const blogs = await collection.find(query).sort({
            createdAt: -1
        }).limit(filter === 'latest' ? 10 : 100).toArray();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(serializedBlogs);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4b1bedd8._.js.map